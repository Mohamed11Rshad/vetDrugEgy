...
class DrugDetailsView extends StatefulWidget {
  ...
  DrugDetailsView({Key? key, required this.ad}) : super(key: key);
...
class DrugDetailsViewState extends State<DrugDetailsView> {
          ...
          children: [
            Container(
              ...
              child:   CachedNetworkImage(
                imageUrl:
                '${ConstantImages.baseURL}${ConstantImages.imgDrugs}${widget.ad.id}.jpg',
        ...
        child: FB5Row(
          children:[
                      FB5Col(classNames: 'col-12  mt-5', child:   Container(
                        ...
                        child:  ImagePager(screenname: "drugdetail"),
                        height:  context.screenHeight * 0.2,
                        width: context.screenWidth,
                      ),),
            FB5Col(
