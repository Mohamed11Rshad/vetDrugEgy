...
class DrugsViewState extends State<DrugsView> {
...
String searchQuery="";
  ...
  Future<void> getData() async {
    ...
    if(_isNumeric(searchQuery)){
      _userModel = (await DrugsController().GetDrugs(
      ...
      body: Column(
        children: [
         Container(
                        ...
                        child:  ImagePager(screenname: "drugview"),
     ...
     UserData.userId>0?  Padding(
            ...
            child: MaterialButton(
                ...
                onPressed: () {
                  ...
                  context.navigateTo(DrugsViewAdmin(isDrug:widget.isDrug!,categoryId:widget.categoryId!));
                }
            ),
          ):SizedBox(),
          Padding(
