...
import 'package:vetdrugegy/Views/DrugEditView.dart';
...
class DrugsViewAdmin extends StatefulWidget {
  final bool? isDrug;
final int? categoryId;
  const DrugsViewAdmin(
      {Key? key,
...
class DrugsViewState extends State<DrugsViewAdmin> {
  late List<Drugs>? _userModel = [];
  bool? isDrug;
  ...
  Future<void> getData() async {
    ...
    _userModel = (await DrugsController().GetDrugsByUserId(
      ...
      body: Column(
        children: [
                  Container(
                        ...
                        child:  ImagePager(screenname: "drugviewadmin"),
          ...
          Padding(
            ...
            child: MaterialButton(
                ...
                onPressed: () {
                  context.navigateTo(DrugAddView(isDrug:widget.isDrug!,categoryId:widget.categoryId!));
                }
            ),
          ),
          Padding(
                ...
                child: ListView.builder(
                          ...
                          child: Card(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  context.navigateTo(
                                      DrugDetailsView(ad: _userModel![index]));
                                },
                                child: Flex(
                                    ...
                                    Expanded(
                                      ...
                                      child: Padding(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl:
                                            '${ConstantImages.baseURL}${ConstantImages.imgDrugs}${_userModel![index].id}.jpg',
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  constraints: BoxConstraints(
                                                      ...
                                                      context.screenWidth *
                                                          0.5),
                                                  child: Text( UserData.language=="ar"?
                                                    _userModel![index]
                                                        .name
                 ...
                 Row(
                                              ...
                                              Expanded(
                                                  child: Padding(
                                                    ...
                                                    child: MaterialButton(
                                                        ...
                                                        onPressed: () async {
                                 context.navigateTo(DrugEditView(drug: _userModel![index]));
                  ...
                  Widget continueButton = TextButton(
                    ...
                    onPressed:  () async {          await DrugsController().DrugDelete(_userModel![index].id).then((isSucc) {
