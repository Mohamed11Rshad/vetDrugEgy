...
Jobs job;
  //constructor
  JobEditView({Key? key,required this.job}) : super(key: key);

  @override
  _JobAdd createState() => _JobAdd();
}

class _JobAdd extends State<JobEditView> {
...
void getJob(){
    nameController.text=widget.job.name;
        descriptionController.text=widget.job.details;
    contactController.text=widget.job.phone;
    addressController.text=widget.job.city;
    selectedGoverment=widget.job.government;
...
try{
       final bytes2 =
          ...
          controller
              .EditJob(
              new Jobs(id: widget.job.id, name: nameController.text, details: descriptionController.text, government: selectedGoverment, city: addressController.text,phone: contactController.text,userId: UserData.userId,attachment: base64Attachment))
              .then((user) {
            if (user != null) {
  ...
  Widget build(BuildContext context) {
            ...
            child: Container(
              child: FB5Row(
                ...
                children: [
                        ...
                        child:  ImagePager(screenname: "jobedit"),
    ...
    FB5Col(classNames: 'col-12 col-md-3', child: Padding(
                  ...
                  FB5Col( classNames: 'col-12 col-md-9 mb-4', child: AuthTextField(
                    labelText: "",
                    obscureText: false,
                            initialValue: contactController.text,
