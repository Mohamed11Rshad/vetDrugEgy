...
class DrugAddView extends StatefulWidget {
  bool? isDrug;
  int? categoryId;

  //constructor
  DrugAddView({Key? key,this.isDrug,this.categoryId}) : super(key: key);

  @override
  _DrugAdd createState() => _DrugAdd();
}

class _DrugAdd extends State<DrugAddView> {
...
try{
       final bytes2 =
          ...
          controller
              .AddDrug(
              new Drugs(id: 0,nameEn:nameEn, name: name, company: company, activeIngredientId: activeIngredientId, price: num.parse(StaticFuncs.replaceArabicNumber(price)),description: description,descriptionEn: description,image:base64Image,attachment: base64Attachment, companyEn: company, isDrug: isDrug, userId: UserData.userId,divisionId: categoryId))
              .then((user) {
            if (user != null) {
            ...
            child: Container(
              child: FB5Row(
                ...
                children: [
                        ...
                        child:  ImagePager(screenname: "drugadd"),
